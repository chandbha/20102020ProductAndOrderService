...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  //      log.info("{} to {}", servletWebRequest.getHttpMethod(), servletWebRequest.getRequest().getServletPath());
    ...
    protected ResponseEntity<Object> handleEntityNotFound(
            RestEntityNotFoundException ex) {
    ...
    protected ResponseEntity<Object> handleEntityNotFound(javax.persistence.EntityNotFoundException ex) {
        return buildResponseEntity(new RestApiError(NOT_FOUND, ex));
    }
    ...
    protected ResponseEntity<Object> handleCommonServerException(MethodArgumentTypeMismatchException ex,
                                                                      WebRequest request) {
        RestApiError apiError = new RestApiError(BAD_REQUEST);
        apiError.setMessage(ex.getMessage());
        apiError.setDebugMessage(ex.getMessage());
